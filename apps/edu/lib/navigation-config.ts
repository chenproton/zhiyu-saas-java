  ...
  sideNavItems: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "resources-document", label: "文档资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-spreadsheet", label: "表格资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-image", label: "图片资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-link", label: "链接资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-audio", label: "音频资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-video", label: "视频资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-archive", label: "压缩包资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-venue", label: "场地资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-facility", label: "设施设备资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-software", label: "软件资源库", href: "/library/resources", matchers: ["/library/resources"] },
        { id: "resources-other", label: "其他资源库", href: "/library/resources", matchers: ["/library/resources"] },
