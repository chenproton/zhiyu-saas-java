...
export function RankingList({ positions = [], industryMap }: RankingListProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#e7e5e4] px-5 py-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="icon"
            className="h-6 w-6 rounded-md border-[#e2e8f0] bg-white text-[#64748b] hover:border-blue-500 hover:text-blue-500 disabled:opacity-30"
            disabled={page <= 0}
            onClick={() => setPage(page - 1)}
          >
            <ChevronLeft className="w-3 h-3" />
          </Button>
          <span className="text-xs text-[#94a3b8] min-w-[40px] text-center">{page + 1} / {totalPages}</span>
          <Button
            variant="outline"
            size="icon"
            className="h-6 w-6 rounded-md border-[#e2e8f0] bg-white text-[#64748b] hover:border-blue-500 hover:text-blue-500 disabled:opacity-30"
