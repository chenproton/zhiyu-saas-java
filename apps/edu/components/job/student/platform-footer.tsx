...
export function PlatformFooter() {
  return (
    <footer className="bg-[#141a2e] mt-auto w-full">
      <div className="h-[3px] bg-gradient-to-r from-[#1677ff] via-[#5aa2ff] to-[#22d3ee]" />
      <div className="max-w-[1600px] mx-auto px-8 py-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <a
              href="#"
              className="text-[#22d3ee] text-[13px] inline-flex items-center gap-1 mt-2 hover:text-[#67e8f9]"
            >
              访问官网 →
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="text-[13px] text-[#a8b3cf] leading-relaxed space-y-1">
              ...
              <li>
                <a href="#" className="text-[#22d3ee] hover:text-[#67e8f9]">
                  使用手册
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-[#6b7a99]">
          <div>
            <a href="#" className="hover:text-[#a8b3cf]">
              隐私政策
            </a>
