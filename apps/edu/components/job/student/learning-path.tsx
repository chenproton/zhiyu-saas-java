    ...
    <div>
      ...
      <div className="relative px-10 pb-6 overflow-hidden">
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white border border-[#e0e0e0] flex items-center justify-center text-[#64748b] hover:border-purple-400 hover:text-purple-600 disabled:opacity-30 shadow-sm"
        >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-white border border-[#e0e0e0] flex items-center justify-center text-[#64748b] hover:border-purple-400 hover:text-purple-600 disabled:opacity-30 shadow-sm"
        >
        ...
        <div ref={wrapperRef} className="overflow-x-auto pb-6 hide-scrollbar">
            ...
            {orderedScenarios.map((scenario, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`text-[15px] font-semibold text-center whitespace-nowrap mb-1 ${isActive ? 'text-purple-600' : 'text-[#1f2937]'}`}
                  >
                    {scenario.name}
                  </div>
          ...
          <div className="w-10 h-1 bg-[#e0e0e0] rounded mx-auto overflow-hidden">
            <div
              data-thumb
              className="w-5 h-full bg-gradient-to-r from-purple-500 to-purple-400 rounded transition-transform"
            />
          </div>
        </div>
      </div>
            ...
            {activeTasks.map((task, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    className="text-xs px-3 py-1.5 rounded-md bg-purple-500 text-white hover:bg-purple-600 flex items-center gap-1"
                    onClick={() =>
                      activeScenarioId &&
