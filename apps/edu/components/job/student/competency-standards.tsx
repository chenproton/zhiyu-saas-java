...
export function CompetencyStandards({
  responsibilities,
  bindings,
  abilityPoints,
          ...
          {groups.map((g) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-md text-sm transition-colors mb-1 ${
                activeId === g.duty
                  ? 'bg-[color-mix(in_srgb,var(--primary)_8%,white)] text-primary font-medium'
                  : 'text-[#64748b] hover:bg-[color-mix(in_srgb,var(--primary)_8%,white)] hover:text-primary'
              }`}
            >
              {g.duty}
            </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative mb-6 mx-1" style={{ height: 38 }}>
                        <div
                          className="absolute top-2 left-0 right-0 h-2 bg-[#f5f5f4] rounded-full"
                          style={{ margin: '0 5px' }}
                        />
                        <div
                      ...
                      <div className="flex items-center gap-2 text-xs text-[#64748b] mb-2">
                        ...
                        目标等级：
                        <span className="px-2 py-0.5 rounded bg-[color-mix(in_srgb,var(--primary)_8%,white)] text-primary font-medium">
                          {targetLabel}
                        </span>
                      </div>
