          ...
          {groups.map((g) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-md text-sm transition-colors mb-1 ${
                activeId === g.duty
                  ? 'bg-[#eff6ff] text-blue-600 font-medium'
                  : 'text-[#64748b] hover:bg-[#eff6ff] hover:text-blue-600'
              }`}
            >
              {g.duty}
            </button>
              ...
              <div className="grid grid-cols-2 max-md:grid-cols-1 gap-4">
                {g.items.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="bg-white border border-[#f5f5f4] rounded-xl p-4 hover:border-blue-200 hover:shadow-sm transition-all"
                    >
