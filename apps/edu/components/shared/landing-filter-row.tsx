...
const ACCENT_CLASSES: Record<string, {
  ...
  purple: {
    ...
    unselected: "bg-slate-50 text-[#475569] border-slate-200 hover:border-purple-300 hover:text-purple-600 hover:bg-purple-50/50",
  ...
  emerald: {
    ...
    unselected: "bg-slate-50 text-[#475569] border-slate-200 hover:border-emerald-300 hover:text-emerald-600 hover:bg-emerald-50/50",
    expand: "text-emerald-500 hover:text-emerald-600",
    border: "border-b border-dashed border-[#cbd5e1]",
  },
  blue: {
    selected: "bg-blue-500 text-white border-blue-500 shadow-sm",
    unselected: "bg-slate-50 text-[#475569] border-slate-200 hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50/50",
