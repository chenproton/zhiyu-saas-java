  ...
  alliance: [
    {
      ...
      title: '产教融合管理',
      desc: '产教资源协同对接中枢',
      href: `${ALLIANCE_PLATFORM_URL}/admin`,
    },
    {
      id: 'alliance-2',
      title: '品牌运营管理',
      desc: '品牌资产配置与发布管理',
      href: `${ALLIANCE_PLATFORM_URL}/admin/brands`,
    },
    {
      id: 'alliance-3',
      title: '就业服务管理',
      desc: '就业项目与岗位推荐管理',
      href: `${ALLIANCE_PLATFORM_URL}/admin/employment`,
    },
    {
      id: 'alliance-4',
      title: '【企业端】服务平台',
      desc: '企业合作伙伴登录入口',
      href: `${ALLIANCE_PLATFORM_URL}/partner/login`,
    },
  ],
  career: [
    {
    ...
    },
    {
      ...
      title: '批次分组管理',
      desc: '批次分组与审批关联管理',
      href: `${CAREER_PLATFORM_URL}/batches`,
    },
    {
      id: 'career-3',
      title: '审批流程管理',
      desc: '审批流模板预设与配置',
      href: `${CAREER_PLATFORM_URL}/workflows`,
    },
  ],
  scene: [
    {
    ...
    },
    {
      ...
      title: '批次分组管理',
      desc: '批次分组与审批关联管理',
      href: `${SCENE_PLATFORM_URL}/batches`,
    },
    {
      id: 'scene-3',
      title: '审批流程管理',
      desc: '审批流模板预设配置',
      href: `${SCENE_PLATFORM_URL}/workflows`,
    },
  ],
  ability: [
    {
      ...
      title: '通用测评管理',
      desc: '测评题库与通用测评管理',
      href: `${ABILITY_PLATFORM_URL}/question-banks`,
    },
    {
      id: 'ability-3',
      title: '测评方式库',
      desc: '能力测评方法与量规配置',
      href: `${ABILITY_PLATFORM_URL}/evaluation-methods`,
    },
    {
      id: 'ability-4',
      title: '毕业设计管理',
      desc: '毕业设计选题与评审管理',
      href: `${ABILITY_PLATFORM_URL}/graduation-project/topics`,
    },
    {
      id: 'ability-5',
      title: '学生画像管理',
      desc: '学生能力画像与成长档案',
      href: `${ABILITY_PLATFORM_URL}/student-portrait/portraits`,
    },
  ],
}
...
const CATEGORY_META: Record<ResourceCategory, { label: string; icon: string; color: string }> = {
        ...
        >
          ...
          <div className="relative px-4 py-3 border-b bg-gradient-to-r from-primary/[0.08] to-transparent flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="relative w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary/70 text-primary-foreground flex items-center justify-center shadow-sm">
                ...
                <div
                  className="absolute -inset-0.5 rounded-full bg-primary/20 animate-pulse"
          ...
          <div className="flex-1 min-h-0 px-4 pb-3 overflow-hidden">
            {isChatMode ? (
              ...
              <div className="h-full overflow-y-auto scrollbar-thin pr-1.5">{resourceList}</div>
            )}
          </div>
