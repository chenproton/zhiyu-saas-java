    ...
    <>
      ...
      <div className="mt-3">
        <div className="flex items-center gap-2">
          <Switch
            checked={cfg.allowResubmit ?? false}
            onCheckedChange={(v) => setCfg({ allowResubmit: v })}
          />
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              <Switch
                ...
                onCheckedChange={(v) => setCfg({ requiresMaterial: v })}
              />
          ...
          {requiresMaterial && (
            <>
              <div>
                ...
                <Input
                  type="number"
                  value={cfg.deadlineDays ?? 7}
                  onChange={(e) =>
                    setCfg({ deadlineDays: Math.max(1, parseInt(e.target.value) || 1) })
                  }
                  className="mt-1 text-sm max-w-[50%]"
                  min={1}
                />
              </div>
              <div className="mt-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {reviewSteps.length > 1 && (
                        <Button
                          ...
                          onClick={() =>
                            setReviewSteps(reviewSteps.filter((s) => s.id !== step.id))
                          }
                        >
        ...
        <div className="border rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-semibold">成果材料要求</h3>
            </div>
            <div className="flex items-center gap-2">
              <Switch
                checked={requiresMaterial}
      ...
      <div className="space-y-4">
        ...
        <div className="border rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <FileText className="h-4 w-4 text-primary" />
              <h3 className="text-sm font-semibold">作业提交要求</h3>
            </div>
            <div className="flex items-center gap-2">
              <Switch
                checked={requiresMaterial}
