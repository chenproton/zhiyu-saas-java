...
const resourceTypeIcons: Record<string, string> = {
  document: 'text-[#3b82f6] bg-primary/5',
        ...
        <div className="max-w-[1400px] mx-auto px-6 py-3 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                <span className="w-8 h-8 rounded-xl bg-gray-100 border border-gray-200/60 flex items-center justify-center group-hover:bg-primary/5 group-hover:border-primary/25 group-hover:text-primary transition-all duration-200">
            ...
            <div className="py-1">
              {tasks.map((task, idx) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <span className="absolute left-0 top-2 bottom-2 w-[3px] bg-gradient-to-b from-primary to-primary/70 rounded-r-full shadow-[0_0_8px_rgba(59,130,246,0.4)]" />
                    )}
                    <div
                      className={cn(
                  ...
                  <TabsContent value="collapsed-knowledge" className="mt-0 space-y-2">
                    {taskKnowledgePoints.length > 0 ? (
                      taskKnowledgePoints.map((kp, i) => (
                        <div
                          key={kp.id}
                          className="flex items-start gap-3 p-2.5 rounded-xl border border-gray-100 hover:border-primary/25 hover:bg-primary/5/30 transition-all cursor-pointer"
                  ...
                  <div className="space-y-2">
                    {activeKnowledgePointCourses.map((c) => (
                      <Link
                        ...
                        className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:border-primary/25 hover:bg-primary/5/30 transition-all group"
                      >
