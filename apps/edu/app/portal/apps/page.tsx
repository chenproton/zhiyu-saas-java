...
const fallbackModules: Record<string, ModuleItem[]> = {
  ...
  career: [
    ...
    { id: "career-recommend-learn", title: "推荐与学习", desc: "岗位推荐与学习路径", note: "管理岗位推荐和智能学习路径", href: "/job/recommend" },
    { id: "career-batch-approval", title: "批次与审批管理", desc: "岗位批次与审批流程", note: "管理岗位招聘批次和审批流程", href: "/job/batches" },
  ],
  course: [
    { id: "course-online-resources", title: "在线课资源库", desc: "体系课与颗粒课管理", note: "管理在线课程体系课和颗粒课资源", href: "/lesson/admin/system" },
    { id: "course-hybrid-resources", title: "混合课资源库", desc: "混合课模板与历史档案", note: "管理混合课模板和历史档案库", href: "/lesson/admin/hybrid" },
    { id: "course-teaching-space", title: "教学空间", desc: "开课计划与教学跟踪", note: "管理开课计划和跟踪学生学习", href: "/lesson/teacher/claim" },
    { id: "course-batch-approval", title: "批次与审批管理", desc: "课程批次与审批流程", note: "管理课程批次分组和审批流程", href: "/lesson/admin/batches" },
  ],
  scene: [
    { id: "scene-center", title: "场景中心", desc: "实践场景与任务设计", note: "创建和管理产业实践场景", href: "/scene/" },
    { id: "scene-batch-approval", title: "批次与审批管理", desc: "场景批次与审批流程", note: "管理场景实践批次和审批流程", href: "/scene/batches" },
  ],
  ability: [
    { id: "ability-exam-resources", title: "测评资源", desc: "题库、试卷与考试管理", note: "建设题库、组织考试与管理测评方式", href: "/evaluation/question-banks" },
    { id: "ability-batch-approval", title: "批次与审批管理", desc: "测评批次与审批流程", note: "管理测评批次和审批流程", href: "/evaluation/batches" },
    { id: "ability-results-cert", title: "结果与认证", desc: "场景结果与微证书", note: "查看场景结果、岗位能力并颁发微证书", href: "/evaluation/scene-results" },
    { id: "ability-graduate-portrait", title: "毕业与画像", desc: "毕业设计与学生画像", note: "管理毕业设计主题和学生画像分析", href: "/evaluation/graduation/topics" },
  ],
  affairs: [
