...
const brandLabel = "人才品牌"
const brandDesc = "管理学生能力画像排名与典型就业案例"
    ...
    <PortalCrudPage
      ...
      renderForm={(item: any, setItem: any) => (
        <div className="space-y-4">
          ...
          <div className="grid gap-2">
            <Label>学生 ID</Label>
            <BrandRelationSelect label="关联学生" value={item.studentId || ""} onChange={(v: any) => setItem({ ...item, studentId: v })} fetchUrl="/users?role=student&limit=1000" />
          </div>
          <div className="grid gap-2">
            <Label>专业 ID</Label>
