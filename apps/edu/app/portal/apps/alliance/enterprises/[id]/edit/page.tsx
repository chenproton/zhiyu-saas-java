      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input value={(item as any).unifiedSocialCreditCode || ""} onChange={(e) => setField("unifiedSocialCreditCode", e.target.value)} />
              </div>
              <div className="grid gap-2">
                <Label>企业类型</Label>
                <Select value={item.enterpriseType || "cooperation"} onValueChange={(v) => setField("enterpriseType", v)}>
              ...
              <div className="grid gap-2">
                <Label>成立年份</Label>
                <Input type="number" value={(item as any).establishedYear ?? ""} onChange={(e) => setField("establishedYear", e.target.value ? Number(e.target.value) : undefined)} />
              </div>
              <div className="grid gap-2">
                <Label>企业规模（人数）</Label>
                <Input type="number" value={(item as any).employeeCount ?? ""} onChange={(e) => setField("employeeCount", e.target.value ? Number(e.target.value) : undefined)} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              <SingleImageUpload label="企业 Logo" value={(item as any).logoUrl || ""} onChange={(v) => setField("logoUrl", v)} />
              <SingleImageUpload label="企业主页封面" value={(item as any).coverImage || ""} onChange={(v) => setField("coverImage", v)} />
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <ImageListUpload label="企业营业执照" value={bizPhotos} onChange={(v) => setField("businessLicensePhotos", v)} />
              <ImageListUpload label="企业知识产权" value={ipPhotos} onChange={(v) => setField("intellectualPropertyPhotos", v)} />
              <ImageListUpload label="企业荣誉资质" value={qualPhotos} onChange={(v) => setField("qualificationPhotos", v)} />
            </CardContent>
          </Card>
