...
interface Tenant {
  ...
  shortName: string; province: string; city: string
        ...
        <div className="rounded-lg border border-gray-100 bg-white shadow-sm">
          <div className="px-6 py-5 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div><h2 className="text-lg font-semibold">{tenant.enterpriseName}</h2><p className="text-sm text-muted-foreground">{tenant.educationLevel !== "-" ? tenant.educationLevel : ""} {tenant.educationNature !== "-" ? `/ ${tenant.educationNature}` : ""}</p></div>
            </div>
          </div>
