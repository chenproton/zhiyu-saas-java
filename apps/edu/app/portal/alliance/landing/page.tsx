  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
      <div className="flex items-center gap-3">
        <div className="h-6 w-1.5 rounded-full bg-gradient-to-b from-primary to-primary/70" />
...
function ViewAllLink({ href }: { href: string }) {
  return (
    <Link
      href={href}
      className="group inline-flex items-center gap-1 text-sm font-medium text-primary hover:text-primary transition-colors"
    >
      查看全部
            ...
            <span
              className={`block w-2.5 h-2.5 rounded-full border-2 transition-all duration-300 ${
                active
                  ...
                  : 'bg-white border-slate-300 group-hover:border-primary/40'
              }`}
            />
          </button>
        )
    ...
    <Card className="border border-white/10 shadow-2xl shadow-black/20 rounded-2xl overflow-hidden bg-white/10 backdrop-blur-xl">
      <CardContent className="p-7">
          ...
          <div className="flex-1 min-w-0">
            ...
            {schoolInfo.website && (
              <a
                ...
                className="text-sm text-primary/80 hover:text-white mt-1 inline-flex items-center gap-1"
              >
        ...
        <div className="grid grid-cols-3 gap-4 mt-7 py-6 border-y border-white/10">
          ...
          <div className="text-center">
            <p className="text-3xl font-bold text-primary/80">{scale.teacherCount ?? '—'}</p>
            <p className="text-xs text-slate-400 mt-1">教师</p>
          </div>
          <div className="text-center">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/15 rounded-full blur-[140px] -translate-y-1/3 translate-x-1/4" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-primary/15 rounded-full blur-[120px] translate-y-1/3 -translate-x-1/4" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white mb-6 leading-[1.15] tracking-tight">
                搭建产教融合桥梁
                <span className="block mt-2 bg-clip-text text-transparent bg-gradient-to-r from-primary/70 via-primary/40 to-primary/70">
                  共育产业英才
                </span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  asChild
                  className="rounded-full px-7 py-5 text-sm font-semibold bg-gradient-to-r from-primary to-primary/70 hover:from-primary/90 hover:to-primary/70 text-white shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/20 hover:-translate-y-0.5"
                >
      ...
      <section
        ...
        className="relative py-20 bg-gradient-to-b from-slate-50/90 via-white to-primary/5 overflow-hidden"
      >
              ...
              return (
                <Link key={cat.id} href={cat.href}>
                  <div className="group flex items-center gap-3 px-5 py-3 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-lg hover:shadow-primary/10 hover:border-primary/30 hover:bg-primary/5 transition-all duration-300 hover:-translate-y-0.5">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 flex items-center justify-center group-hover:from-primary/10 group-hover:to-primary/15 transition-colors">
          ...
          {data.brands.length > 0 && (
            <Tabs defaultValue={BRAND_CATEGORIES[0].id} className="w-full">
              <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                <div className="flex items-center gap-3">
                  <div className="h-6 w-1 rounded-full bg-gradient-to-b from-primary to-primary/70" />
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/8 via-primary/5 to-primary/6" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/80 border border-primary/10 text-primary text-xs font-medium mb-5 shadow-sm">
            <Sparkles className="w-3.5 h-3.5" />
            共建生态
          </div>
          ...
          <Button
            asChild
            className="rounded-full px-8 py-5 text-sm font-semibold bg-gradient-to-r from-primary to-primary/70 hover:from-primary/90 hover:to-primary/70 text-white shadow-lg shadow-primary/20 transition-all hover:shadow-xl hover:shadow-primary/15 hover:-translate-y-0.5"
          >
