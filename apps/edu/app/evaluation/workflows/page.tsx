  ...
  const handleSave = async () => {
    ...
    try {
      const body = {
        ...
        scene: "evaluation", status: "active" as const,
        majorIds,
      }
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-semibold text-gray-800">审批流程配置</h1><p className="text-sm text-gray-500 mt-1">配置测评审批流模板，供批次关联使用</p></div>
      ...
      <Card>
        <CardHeader><CardTitle className="text-base flex items-center gap-2"><GitBranch className="h-4 w-4" />审批流程列表</CardTitle><CardDescription>共 {filteredWorkflows.length} 个审批流程</CardDescription></CardHeader>
        <CardContent>
