...
function BankCard({ bank, index }: { bank: QuestionBank; index: number }) {
  return (
    ...
    >
      <div className="bg-white rounded-2xl border border-[#e7e5e4] overflow-hidden hover:shadow-[0_8px_28px_rgba(0,0,0,0.1)] hover:border-emerald-300 hover:-translate-y-1 transition-all h-full flex flex-col shadow-[0_2px_6px_rgba(0,0,0,0.04)]">
        <div
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-400 border-t border-slate-50 pt-3">
            ...
            <span className="text-emerald-600 group-hover:text-emerald-600 font-medium">
              查看详情 →
            </span>
          </div>
        </div>
    ...
    >
      <div className="bg-white rounded-2xl border border-[#e7e5e4] overflow-hidden hover:shadow-[0_8px_28px_rgba(0,0,0,0.1)] hover:border-emerald-300 hover:-translate-y-1 transition-all h-full flex flex-col shadow-[0_2px_6px_rgba(0,0,0,0.04)]">
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <Button className="w-full rounded-[10px] h-9 text-xs bg-gradient-to-r from-emerald-500 to-emerald-400 hover:from-emerald-600 hover:to-emerald-500 text-white shadow-md shadow-emerald-500/20 hover:shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-0.5 transition-all">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f5f8ff]">
      ...
      <div className="relative w-full pt-16 overflow-hidden">
        ...
        />
        <div className="absolute top-[-120px] right-[-5%] w-[500px] h-[500px] rounded-full bg-emerald-500/20 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[-80px] left-[8%] w-[400px] h-[400px] rounded-full bg-emerald-500/15 blur-[100px] pointer-events-none" />
        <div className="absolute top-[20%] left-[30%] w-[300px] h-[300px] rounded-full bg-emerald-500/10 blur-[80px] pointer-events-none" />
      ...
      <main ref={listRef} className="max-w-[1400px] mx-auto px-8 py-8 w-full flex-1">
        {/* 考试中心入口 */}
        <div className="bg-gradient-to-r from-emerald-500 via-emerald-500 to-emerald-400 rounded-2xl p-6 mb-6 shadow-[0_8px_24px_rgba(16,185,129,0.25)] relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Button
              asChild
              className="bg-white text-emerald-600 hover:bg-emerald-50 hover:-translate-y-0.5 rounded-full px-6 h-10 text-sm font-semibold shadow-lg transition-all shrink-0"
            >
        ...
        <div className="bg-white rounded-2xl border border-[#e7e5e4] shadow-[0_4px_20px_rgba(0,0,0,0.04)] p-6 mb-6">
          ...
          {(keyword.trim() || selectedBatch !== '全部') && (
            <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-dashed border-[#cbd5e1]">
              ...
              {keyword.trim() && (
                <span className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-600 text-xs px-2.5 py-1 rounded-full border border-emerald-100">
                  关键词：{keyword.trim()}
                  <X
          ...
          <div className="flex items-center gap-0.5 bg-white p-1 rounded-xl border border-[#e7e5e4] shadow-sm">
            {SORT_OPTIONS.map((s) => (
              <button
                ...
                className={`px-5 py-2 rounded-[10px] text-[13px] transition-all font-medium ${sort === s.value ? 'bg-emerald-500 text-white shadow-md' : 'text-[#475569] hover:text-emerald-600 hover:bg-emerald-50'}`}
              >
                {s.label}
              </button>
            ))}
        ...
        <div className="text-[13px] text-[#64748b] mb-6">
          <span className="inline-flex items-center gap-1.5">
            ...
            当前共展示{' '}
            <b className="text-emerald-600">{filteredBanks.length + filteredExams.length}</b> 个资源
          </span>
        </div>
