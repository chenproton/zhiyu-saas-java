        ...
        <CardContent className="p-0">
          <div className="rounded-lg border border-slate-200 bg-white overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {loading ? (
                  <TableRow><TableCell colSpan={12} className="text-center py-8 text-gray-500">加载中...</TableCell></TableRow>
                ) : data.length === 0 ? (
                  <TableRow><TableCell colSpan={12} className="text-center py-12 text-gray-500">暂无数据</TableCell></TableRow>
                ) : (
                  data.map((item) => (
                    <TableRow key={item.id}>
                      <TableCell className="text-center">
                        <Checkbox
                          ...
                          aria-label={`选择审批 ${item.courseName}`}
                        />
                      </TableCell>
