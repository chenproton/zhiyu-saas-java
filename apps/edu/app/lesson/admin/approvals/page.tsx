...
export default function CourseApprovalsPage() {
  const { records, loading, approve, reject, batchApprove, batchReject } = useApprovals({ targetType: "course" })
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan={11} className="text-center py-12 text-gray-500">暂无数据</TableCell></TableRow>
                ) : (
                  data.map((item) => (
