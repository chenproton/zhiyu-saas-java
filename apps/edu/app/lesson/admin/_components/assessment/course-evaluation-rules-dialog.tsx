...
import { examApi, examUsageApi, randomDrawQuestionApi, majorApi } from "@/lib/api"
...
export function CourseEvaluationRulesDialog({
  ...
  // Preload random draw questions and majors
  useEffect(() => { loadRdqQuestions(); loadMajors() }, [loadRdqQuestions, loadMajors])
