(function () {
  // Vendored from https://cdn.unlayer.com/image-editor/embed.js (2026-08-04).
  // base rewritten to same-origin path for fully offline self-hosting.
  var base = '/image-editor';
