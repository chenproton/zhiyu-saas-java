...
/**
 * 教务审批流程控制器（对齐 Go routes_affairs.go /affairs/workflows 路由组）。
 *
 * <p>与 /api/v1/workflows（JobWorkflowController）同源：Go 端同挂 workflowHandler，
 * 此处复用 {@link IJobWorkflowService}，语义完全一致。</p>
 *
 * @author zhiyu
 */
@Validated
...
@RestController
@RequestMapping("/api/v1/affairs/workflows")
