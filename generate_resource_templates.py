...
def create_students():
    ...
    ws = wb.active
    ws.title = "学生列表"
    headers = ["登录账号(学号) *", "姓名 *", "密码 *", "班级(组织节点路径) *", "状态"]
    widths = [24, 16, 20, 36, 12]
    note = (
        "填写说明：\n"
        "* 必填列。\n"
    ...
    data = [
        ("S2024001", "张三", "Zhangsan2024", "某某职业技术学院-信息工程学院-软件技术2401班", "在籍"),
        ("S2024002", "李四", "Lisi2024abc", "某某职业技术学院-信息工程学院-软件技术2401班", "在籍"),
        ("S2024003", "王五", "Wangwu2024", "某某职业技术学院-信息工程学院-软件技术2402班", "在籍"),
        ("S2024004", "赵六", "Zhaoliu2024", "某某职业技术学院-信息工程学院-人工智能2401班", "在籍"),
        ("S2024005", "孙七", "Sunqi2024", "某某职业技术学院-汽车工程学院-新能源汽车2401班", "在籍"),
        ("S2024006", "周八", "Zhouba2024", "某某职业技术学院-汽车工程学院-新能源汽车2402班", "在籍"),
        ("S2024007", "吴九", "Wujiu2024", "某某职业技术学院-智能制造学院-工业机器人2401班", "在籍"),
        ("S2024008", "郑十", "Zhengshi2024", "某某职业技术学院-经济管理学院-大数据与会计2401班", "在籍"),
        ("S2024009", "钱十一", "Qian1112024", "某某职业技术学院-信息工程学院-软件技术2401班", "在籍"),
        ("S2024010", "冯十二", "Feng12_2024", "某某职业技术学院-信息工程学院-人工智能2401班", "在籍"),
    ]
    for i, row in enumerate(data, start=3):
        add_row(ws, i, row)
...
def create_teachers():
    ...
    ws = wb.active
    ws.title = "教师列表"
    headers = ["登录账号(工号) *", "姓名 *", "密码 *", "所属组织节点(路径)", "职位(逗号分隔)", "状态"]
    widths = [24, 16, 20, 36, 28, 12]
    note = (
        "填写说明：\n"
        "* 必填列。\n"
    ...
    data = [
        ("T001", "陈教授", "Chen2024prof", "某某职业技术学院-信息工程学院", "教授,专业带头人", "在职"),
        ("T002", "刘老师", "Liu2024tea", "某某职业技术学院-信息工程学院", "讲师", "在职"),
        ("T003", "王老师", "Wang2024tea", "某某职业技术学院-汽车工程学院", "副教授", "在职"),
        ("T004", "赵老师", "Zhao2024tea", "某某职业技术学院-智能制造学院", "讲师", "在职"),
        ("T005", "孙老师", "Sun2024tea", "某某职业技术学院-经济管理学院", "助教", "在职"),
        ("T006", "周工", "Zhou2024eng", "某某职业技术学院-汽车工程学院", "企业导师", "外聘"),
        ("T007", "吴老师", "Wu2024tea", "某某职业技术学院-信息工程学院", "讲师", "在职"),
        ("T008", "郑老师", "Zheng2024tea", "某某职业技术学院-智能制造学院", "教授", "在职"),
    ]
    for i, row in enumerate(data, start=3):
        add_row(ws, i, row)
