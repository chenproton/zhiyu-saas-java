...
export const termApi = {
  ...
  delete: (id: string) =>
    request<{ id: string }>(`/affairs/terms/${id}`, { method: "DELETE" }),
}

// ==================== 人才培养方案 ====================

export const programApi = {
  list: (params?: { search?: string; status?: string; majorId?: string; entryYear?: number; limit?: number; offset?: number }) =>
  ...
  update: (id: string, req: TrainingProgramPayload) =>
    request<TrainingProgram>(`/affairs/programs/${id}`, { method: "PUT", body: JSON.stringify(req) }),
  delete: (id: string) =>
    request<{ id: string }>(`/affairs/programs/${id}`, { method: "DELETE" }),
  /** draft/published 状态切换（默认切换为 published） */
  publish: (id: string, status: "draft" | "published" = "published") =>
    request<TrainingProgram>(`/affairs/programs/${id}/publish`, { method: "POST", body: JSON.stringify({ status }) }),
...
export const teachingPlanApi = {
  list: (params?: { termId?: string; programId?: string; status?: string; majorId?: string; limit?: number; offset?: number }) =>
...
export const venueApi = {
  ...
  delete: (id: string) =>
    request<{ id: string }>(`/affairs/venues/${id}`, { method: "DELETE" }),
}
...
export const periodSlotApi = {
  ...
  update: (id: string, req: PeriodSlotPayload) =>
    request<PeriodSlot>(`/affairs/period-slots/${id}`, { method: "PUT", body: JSON.stringify(req) }),
  delete: (id: string) =>
...
export const scheduleApi = {
  list: (params?: { termId?: string; status?: string; classNodeId?: string; teacherId?: string; type?: string; limit?: number; offset?: number }) =>
  ...
  delete: (id: string) =>
    request<{ id: string }>(`/affairs/schedules/${id}`, { method: "DELETE" }),
