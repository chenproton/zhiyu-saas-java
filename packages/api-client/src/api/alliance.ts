...
export const allianceApi = {
  ...
  enterpriseAgreements: {
    list: (enterpriseId: string) =>
      portalRequest<AllianceListResponse<AllianceEnterpriseAgreement>>(
        `/alliance/enterprises/${enterpriseId}/agreements`,
      ),
    create: (enterpriseId: string, data: Partial<AllianceEnterpriseAgreement>) =>
      portalRequest<AllianceEnterpriseAgreement>(
        `/alliance/enterprises/${enterpriseId}/agreements`,
        { method: 'POST', body: JSON.stringify(data) },
      ),
    update: (enterpriseId: string, id: string, data: Partial<AllianceEnterpriseAgreement>) =>
      portalRequest<AllianceEnterpriseAgreement>(
        `/alliance/enterprises/${enterpriseId}/agreements/${id}`,
        { method: 'PUT', body: JSON.stringify(data) },
      ),
    delete: (enterpriseId: string, id: string) =>
      portalRequest<{ id: string }>(`/alliance/enterprises/${enterpriseId}/agreements/${id}`, {
        method: 'DELETE',
      }),
  },
  ...
  projects: {
    list: (params?: { search?: string; phase?: string; page?: number; limit?: number }) =>
      portalRequest<AllianceListResponse<AllianceProject>>(
        `/alliance/projects${buildQuery(params || {})}`,
      ),
  ...
  milestones: {
    ...
    create: (projectId: string, data: Partial<AllianceProjectMilestone>) =>
      portalRequest<{ id: string }>(`/alliance/projects/${projectId}/milestones`, {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (projectId: string, id: string, data: Partial<AllianceProjectMilestone>) =>
      portalRequest<{ id: string }>(`/alliance/projects/${projectId}/milestones/${id}`, {
        method: 'PUT',
        body: JSON.stringify(data),
      }),
  ...
  experts: {
    list: (params?: { search?: string; status?: string; page?: number; limit?: number }) =>
      portalRequest<AllianceListResponse<AllianceExpert>>(
        `/alliance/experts${buildQuery(params || {})}`,
      ),
  ...
  agreements: {
    list: (params?: { search?: string; status?: string; page?: number; limit?: number }) =>
      portalRequest<AllianceListResponse<AllianceAgreement>>(
        `/alliance/agreements${buildQuery(params || {})}`,
      ),
  ...
  permissions: {
    list: (params?: { search?: string; page?: number; limit?: number }) =>
      portalRequest<AllianceListResponse<AlliancePermission>>(
        `/alliance/permissions${buildQuery(params || {})}`,
      ),
    create: (data: Partial<AlliancePermission>) =>
      portalRequest<{ id: string }>('/alliance/permissions', {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (id: string, data: Partial<AlliancePermission>) =>
      portalRequest<{ id: string }>(`/alliance/permissions/${id}`, {
        method: 'PUT',
        body: JSON.stringify(data),
      }),
    delete: (id: string) =>
  ...
  dictionaries: {
    ...
    create: (dictType: string, data: { code: string; name: string; sortOrder?: number }) =>
      portalRequest<{ id: string }>(`/alliance/dictionaries/${dictType}`, {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (dictType: string, id: string, data: { name: string; sortOrder?: number }) =>
      portalRequest<{ id: string }>(`/alliance/dictionaries/${dictType}/${id}`, {
        method: 'PUT',
        body: JSON.stringify(data),
      }),
  ...
  brands: {
    list: (params?: {
      ...
      portalRequest<AllianceListResponse<AllianceBrand>>(
        `/alliance/brands${buildQuery(params || {})}`,
      ),
  ...
  public: {
    ...
    schoolInfo: (tenantId: string) =>
      portalRequest<AllianceSchoolInfo>(`/alliance/public/school-info?tenantId=${tenantId}`),
    enterprises: () =>
      portalRequest<AllianceListResponse<AllianceEnterprise>>('/alliance/public/enterprises'),
    enterprise: (id: string) =>
      portalRequest<AllianceEnterprise>(`/alliance/public/enterprises/${id}`),
    projects: () =>
      portalRequest<AllianceListResponse<AllianceProject>>('/alliance/public/projects'),
    project: (id: string) => portalRequest<AllianceProject>(`/alliance/public/projects/${id}`),
    achievements: () =>
      portalRequest<AllianceListResponse<AllianceAchievement>>('/alliance/public/achievements'),
    ...
    brands: (brandType?: string) =>
      portalRequest<AllianceListResponse<AllianceBrand>>(
        `/alliance/public/brands${brandType ? `?brandType=${brandType}` : ''}`,
      ),
