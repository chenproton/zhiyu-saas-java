...
| **写/改前端页面组件** | Vue 门户/管理端（`frontend/portal-vue`、`frontend/plus-ui`）：[`spec/vue-business-portal.md`](spec/vue-business-portal.md) + 根 `AGENTS.md` 第二部分（Element Plus / RuoYi 组件体系） |
