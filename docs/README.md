...
- **规范/红线**：`refactor-layering.md`、`ai-development.md`、`spec-standards.md`、`documentation-standards.md`、`prose-standards.md`、`code-review-checklist.md`、`simplification-notes.md`
