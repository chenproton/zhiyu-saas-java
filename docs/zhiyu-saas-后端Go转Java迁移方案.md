...
> 本文档为本框架（saas-framework6-java-vue）视角下的迁移指南：供将 zhiyu-saas（Go）业务系统迁移到本框架（Java）时使用；源规划文档位于 zhiyu-saas 仓库 `docs/backend-go-to-java-migration.md`，两处如有出入以本仓库为准。
