...
func registerPartnerRoutes(r chi.Router, h *Handlers, passwordLimiter func(http.Handler) http.Handler) {
	...
	r.Group(func(r chi.Router) {
		...
		// 专家档案详情仅管理员；专家本人档案走 /me（member 无详情权限）
		...
		r.Get("/partner/co-build/scenes/{id}/weights", h.partnerCoBuildHandler.ListScenarioWeights)
		r.Put("/partner/co-build/scenes/{id}/weights", h.partnerCoBuildHandler.SaveScenarioWeights)
		...
		r.Get("/partner/co-build/schools/{tenantId}/knowledge-points", h.partnerCoBuildHandler.ListSchoolKnowledgePoints)
		r.Get("/partner/co-build/schools/{tenantId}/courses", h.partnerCoBuildHandler.ListSchoolCourses)
		r.Get("/partner/co-build/schools/{tenantId}/ability-bindings", h.partnerCoBuildHandler.ListSchoolAbilityBindings)
		r.Get("/partner/co-build/schools/{tenantId}/question-banks", h.partnerCoBuildHandler.ListSchoolQuestionBanks)
		r.Get("/partner/co-build/schools/{tenantId}/questions", h.partnerCoBuildHandler.ListSchoolQuestions)
		r.Get("/partner/co-build/schools/{tenantId}/random-draw-questions", h.partnerCoBuildHandler.ListSchoolRandomDrawQuestions)
		r.Get("/partner/co-build/schools/{tenantId}/exams", h.partnerCoBuildHandler.ListSchoolExams)
		r.Get("/partner/co-build/schools/{tenantId}/majors", h.partnerCoBuildHandler.ListSchoolMajors)
		r.Get("/partner/co-build/schools/{tenantId}/scenarios", h.partnerCoBuildHandler.ListSchoolScenarios)
		r.Get("/partner/co-build/schools/{tenantId}/tasks", h.partnerCoBuildHandler.ListSchoolTasks)
		r.Get("/partner/co-build/schools/{tenantId}/resources", h.partnerCoBuildHandler.ListSchoolResources)
	})
