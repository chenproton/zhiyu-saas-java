...
func TestListQueryConfigsMatchWhitelists(t *testing.T) {
	...
	checkConfig(t, "graduation_topics", NewGraduationStore(q, b).ListTopicsConfig())
	checkConfig(t, "graduation_archives", NewGraduationStore(q, b).ListArchivesConfig())
	checkConfig(t, "graduation_evaluations", NewGraduationStore(q, b).ListEvaluationsConfig())
	...
	checkConfig(t, "micro_cert_templates", NewMicroCertStore(q, b).ListTemplateConfig())
	checkConfig(t, "cert_issuance_records", NewMicroCertStore(q, b).ListIssuanceConfig())
