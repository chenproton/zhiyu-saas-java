...
func TestListQueryConfigsMatchWhitelists(t *testing.T) {
	...
	checkConfig(t, "alliance_employment_projects", NewAllianceStore(q).ListEmploymentProjectsConfig())
	checkConfig(t, "alliance_employment_jobs", NewAllianceStore(q).ListEmploymentJobsConfig())
	checkConfig(t, "alliance_employment_applications", NewAllianceStore(q).ListEmploymentApplicationsConfig())
