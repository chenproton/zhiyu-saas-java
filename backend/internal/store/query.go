...
var (
	...
	allowedListQuerySelectColumns = []string{
		...
		"id, tenant_id, name, type, organizer, description, cover_image, start_date, end_date, publish_status, enterprise_ids, target_groups, created_by, created_at, updated_at",
