...
const allianceDictSeedSQL = `
	...
	FROM (VALUES
		('cooperation_type', 'talent_training', '人才培养', 1),
		('cooperation_type', 'internship', '实习实训', 2),
		('cooperation_type', 'tech_rd', '技术研发', 3),
		('cooperation_type', 'course_co_build', '课程共建', 4),
		('cooperation_type', 'teacher_training', '师资培训', 5),
		('cooperation_type', 'employment', '就业合作', 6),
		...
		('agreement_type', 'strategic', '战略合作协议', 1),
		('agreement_type', 'industry_academia_research', '产学研合作协议', 2),
		('agreement_type', 'internship', '实习实训协议', 3),
		('agreement_type', 'talent_training', '人才培养协议', 4),
		('agreement_type', 'employment', '就业合作协议', 5),
		('agreement_type', 'course_co_build', '课程共建协议', 6),
		('agreement_type', 'technical_service', '技术服务协议', 7),
		...
		('project_type', 'talent_training', '人才培养项目', 1),
		('project_type', 'tech_rd', '技术研发项目', 2),
		('project_type', 'base_construction', '基地建设项目', 3),
		('project_type', 'skill_competition', '技能竞赛项目', 4),
		('project_type', 'innovation_startup', '创新创业项目', 5),
		('project_type', 'teacher_training', '师资培训项目', 6),
		('project_type', 'course_development', '课程开发项目', 7),
		('project_type', 'major_co_build', '专业共建项目', 8)
