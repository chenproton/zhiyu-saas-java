...
func (h *LearnRoadHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondError(w, http.StatusInternalServerError, "查询学习路线失败")
		return
	}
	defer rows.Close()
	...
	if err != nil {
		respondError(w, http.StatusInternalServerError, "读取学习路线失败")
		return
	}
...
func (h *LearnRoadHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondError(w, http.StatusNotFound, "学习路线不存在")
		return
	}
...
func (h *LearnRoadHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		respondError(w, http.StatusInternalServerError, "创建学习路线失败")
		return
	}
...
func (h *LearnRoadHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		respondError(w, http.StatusInternalServerError, "更新学习路线失败")
		return
	}
...
func (h *LearnRoadHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondError(w, http.StatusInternalServerError, "删除学习路线失败")
		return
	}
