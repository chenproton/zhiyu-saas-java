...
func NewHandlers(db *pgxpool.Pool, jwtSecret string, fileHandler *handler.FileHandler, redisClient *redis.Client) *Handlers {
	...
	return &Handlers{
		...
		resourceCodeHandler:           &handler.ResourceCodeHandler{Service: service.NewPositionService(svc)},
		logHandler:                    &handler.LogHandler{DB: db},
		subscriptionHandler:           &handler.SubscriptionHandler{Service: service.NewPositionService(svc)},
		...
		abilityHandler:                &handler.AbilityHandler{Service: service.NewPositionService(svc)},
		...
		abilityDomainHandler:          &handler.AbilityDomainHandler{Service: service.NewPositionService(svc)},
		jobBatchHandler:               handler.NewJobBatchHandler(db),
		recommendHandler:              &handler.RecommendHandler{Service: service.NewPositionService(svc)},
		learnRoadHandler:              &handler.LearnRoadHandler{DB: db, Store: store.NewLearnRoadsStore(db)},
		jobBannerHandler:              &handler.JobBannerHandler{Service: service.NewPositionService(svc)},
		...
		hybridModuleHandler:           &handler.HybridModuleHandler{Service: service.NewPositionService(svc)},
		courseBatchHandler:            handler.NewCourseBatchHandler(db),
		lessonBehaviorHandler:         &handler.LessonBehaviorHandler{Service: service.NewPositionService(svc)},
		...
		examUsageHandler:              &handler.ExamUsageHandler{Service: service.NewEvaluationService(svc)},
		...
		certificationModelHandler:     &handler.CertificationModelHandler{Service: service.NewEvaluationService(svc)},
		...
		appealHandler:                 &handler.AppealHandler{Service: service.NewEvaluationService(svc)},
		evaluationMethodHandler:       &handler.EvaluationMethodHandler{Service: service.NewEvaluationService(svc)},
		...
		landingHandler:                &handler.LandingHandler{Service: service.NewPositionService(svc)},
		...
		trainingProgramHandler:        &handler.TrainingProgramHandler{Service: service.NewPositionService(svc)},
