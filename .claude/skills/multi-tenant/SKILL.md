...
- `scripts/sql/ry_workflow.sql` 等工作流表仍保留 `tenant_id varchar(40) DEFAULT NULL COMMENT '租户id'` 列（建表层预留）。
...
- `scripts/sql/ry_workflow.sql` —— 工作流表保留 `tenant_id varchar(40)` 列
